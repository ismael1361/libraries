...
<svg width="500" height="500" viewBox="0 0 40 65">
   ...
   <path d="M4,11 A2,1 150 0,1 9,9 A2,1 150 0,1 4,11 Z M31,9 A2,1 30 0,1 36,11 A2,1 30 0,1 31,9 Z" fill="rgba(255, 255, 255, .4)"/>
   
   <path d="M2,22 Q2,20 4,20 Q19,17 36,20 Q38,20 38,22 L37,33 Q37,35 35,35 Q17,33 5,35 Q3,35 3,33 Z M2.5,52 Q3,50 5,50 L35,50 Q37,50 37.5,52 L38,54 Q38,55 37,55 L3,55 Q2,55 2,54 Z" fill="rgba(255, 255, 255, .2)"/>
</svg> 
*/

let p = "M4,11 A2,1 150 0,1 9,9 A2,1 150 0,1 4,11 Z M31,9 A2,1 30 0,1 36,11 A2,1 30 0,1 31,9 Z".replace(/([0-9\.]+)\,([0-9\.]+)/gi, (a, b, c)=>{
  b = Number(b) / 40;
  c = Number(c) / 65;
